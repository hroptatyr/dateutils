AC_DEFUN([_SXE_CHECK_SYS_MMAN], [dnl
	AC_CHECK_HEADERS([sys/mman.h])
])dnl _SXE_CHECK_SYS_MMAN

AC_DEFUN([_SXE_CHECK_MAP_ANON], [dnl
...
])dnl _SXE_CHECK_MAP_ANON

AC_DEFUN([SXE_CHECK_MMAP], [dnl
	AC_REQUIRE([_SXE_CHECK_SYS_MMAN])
	AC_REQUIRE([_SXE_CHECK_MAP_ANON])
])dnl SXE_CHECK_MMAP
